...
public class ChartGenerator {
     ...
     */
    public static void exportScatterChart(String title, String xLabel, String yLabel, XYSeries dataset, String fileName) {
     ...
     * @param fileName      Output filename
     */
    public static void exportScatterChart(String title, String xLabel, String yLabel, XYSeriesCollection dataset, String fileName) {
     ...
     * @param fileName      Output filename
     */
    public static void exportBarChart(String title, String xLabel, String yLabel, DefaultCategoryDataset dataset, String fileName) {

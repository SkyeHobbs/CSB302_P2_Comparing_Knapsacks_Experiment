...
/**
 * Runner for 0/1 Knapsack algorithms.
 * Executes Brute Force, Dynamic Programming, and Greedy algorithms.
...
public class Runner01 {
    ...
    public static void runKnapsack01() {
        ...
        for (String filePath : INPUT_FILES) {
            ...
            dynamicProgrammingProfitDataset.addValue(dynamicProgrammingProfit, "Dynamic Programming", String.valueOf(numOfItems));
            ...
            overallProfitDataset.addValue(dynamicProgrammingProfit, "Dynamic Programming", String.valueOf(numOfItems));
        ...
        ChartGenerator.exportScatterChart("0/1 Knapsack Execution Time - Brute Force", "Number of Items", "Time (ms)", bruteForceTimeSeries, "knapsack01_brute_force_time.png");
        ChartGenerator.exportScatterChart("0/1 Knapsack Execution Time - Dynamic Programming", "Number of Items", "Time (ms)", dynamicProgrammingTimeSeries, "knapsack01_dynamic_programming_time.png");
        ChartGenerator.exportScatterChart("0/1 Knapsack Execution Time - Greedy Algorithm", "Number of Items", "Time (ms)", greedyTimeSeries, "knapsack01_greedy_time.png");
        ...
        ChartGenerator.exportScatterChart("0/1 Knapsack Execution Time - All Algorithms", "Number of Items", "Time (ms)", overallTimeDataset, "knapsack01_all_algorithms_time.png");

        // Generate Profit Charts as Bar Charts
        ChartGenerator.exportBarChart("0/1 Knapsack Profit - Brute Force", "Number of Items", "Profit", bruteForceProfitDataset, "knapsack01_brute_force_profit.png");
        ChartGenerator.exportBarChart("0/1 Knapsack Profit - Dynamic Programming", "Number of Items", "Profit", dynamicProgrammingProfitDataset, "knapsack01_dynamic_programming_profit.png");
        ChartGenerator.exportBarChart("0/1 Knapsack Profit - Greedy Algorithm", "Number of Items", "Profit", greedyProfitDataset, "knapsack01_greedy_profit.png");
        ChartGenerator.exportBarChart("0/1 Knapsack Profit - All Algorithms", "Number of Items", "Profit", overallProfitDataset, "knapsack01_all_algorithms_profit.png");
    }
}